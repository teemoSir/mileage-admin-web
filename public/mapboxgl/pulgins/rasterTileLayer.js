(function (global, factory) {
    ...
    function RasterTileLayer (layerId, layerType, options) {
        ...
        var providers = {
            TianDiTu: {
                Normal: {
                    Map: "http://t0.tianditu.com/DataServer?T=vec_w&X={x}&Y={y}&L={z}&tk={s}",
                    Annotion: "http://t1.tianditu.com/DataServer?T=cva_w&X={x}&Y={y}&L={z}&tk={s}",
                    minzoom: 0,
                    maxzoom: 18
                },
                Satellite: {
                    Map: "http://t2.tianditu.com/DataServer?T=img_w&X={x}&Y={y}&L={z}&tk={s}",
                    Annotion: "http://t3.tianditu.com/DataServer?T=cia_w&X={x}&Y={y}&L={z}&tk={s}",
                    minzoom: 0,
                    maxzoom: 18
                },
                Terrain: {
                    Map: "http://t4.tianditu.com/DataServer?T=ter_w&X={x}&Y={y}&L={z}&tk={s}",
                    Annotion: "http://t5.tianditu.com/DataServer?T=cta_w&X={x}&Y={y}&L={z}&tk={s}",
                    minzoom: 0,
                    maxzoom: 14
                },
                //     "http://t0.tianditu.com/DataServer?T=cia_w&X={x}&Y={y}&L={z}&tk=2afa77972bd56e6da7f45dee6517b59a",
                //     "http://t6.tianditu.com/DataServer?T=cia_w&X={x}&Y={y}&L={z}&tk=5a77920c8a19898beea6943e2c0c5bad",
                //     "http://t7.tianditu.com/DataServer?T=cia_w&X={x}&Y={y}&L={z}&tk=2d7a1be22646b7cad8e925293683e1e8",
                //     "http://t2.tianditu.com/DataServer?T=cia_w&X={x}&Y={y}&L={z}&tk=9998977aa7629c0d5088a986b20567a1",
                //     "http://t7.tianditu.com/DataServer?T=cia_w&X={x}&Y={y}&L={z}&tk=c79e456b185f91ca444db916785d8ebd",
                //Subdomains: ['0', '1', '2', '3', '4', '5', '6', '7'],
                Subdomains: ['2afa77972bd56e6da7f45dee6517b59a', '5a77920c8a19898beea6943e2c0c5bad', '2d7a1be22646b7cad8e925293683e1e8', '9998977aa7629c0d5088a986b20567a1', 'c79e456b185f91ca444db916785d8ebd'],
                key: ""
            },
            GaoDe: {
                Normal: {
            ...
            // csdn 新版本 https://blog.csdn.net/jingjing_n/article/details/127406002
            Baidu: {
                Normal: {
                    Map: '//maponline{s}.bdimg.com/tile/?x={x}&y={y}&z={z}&qt=vtile&styles=pl&showtext=1&scaler=2&v=083',
                },
                Normal_NoTag: {
                    Map: '//maponline{s}.bdimg.com/tile/?x={x}&y={y}&z={z}&qt=vtile&styles=pl&showtext=0&scaler=1&v=083',
                },
                Satellite: {
                    Map: '//maponline{s}.bdimg.com/starpic/u=x={x};y={y};z={z};v=009;type=sate&qt=satepc&fm=46&app=webearth2&v=009',
                    Annotion: '//maponline{s}.bdimg.com/tile/?x={x}&y={y}&z={z}&qt=vtile&styles=sl&showtext=1&scaler=2&v=083'
            ...
            Geovisearth: {
                Satellite: {
                    Map: "https://tiles{s}.geovisearth.com/base/v1/img/{z}/{x}/{y}?format=webp&tmsIds=w&token={key}",
                    minzoom: 3,
                    maxzoom: 18
                },
                Normal: {
                    Map: "https://tiles{s}.geovisearth.com/base/v1/vec/{z}/{x}/{y}?format=png&tmsIds=w&token={key}",
                    minzoom: 3,
                    maxzoom: 18
                },
                Terrain: {
                    Map: "https://tiles{s}.geovisearth.com/base/v1/ter/{z}/{x}/{y}?format=png&tmsIds=w&token={key}",
                    minzoom: 3,
                    maxzoom: 18
                },
                Subdomains: ["0", "1", "2", "3"],
        ...
        var tilelayer;
        if (providerName === 'TianDiTu' || providerName === 'OSM' || providerName === 'Geovisearth' || providerName === 'ArcGIS') {
