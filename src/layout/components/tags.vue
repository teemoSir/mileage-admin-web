	...
	<div class="mileage-tags">
		...
		>
			<div class="right-menu-item" @click="refreshTab">
				<reload-outlined class="mileage-header-tags-right" />
				<div class="pl-3">刷新</div>
			</div>

			<div class="right-menu-item" @click="closeTabs">
				<close-outlined class="mileage-header-tags-right" />
			...
			<div class="right-menu-item" @click="maximize">
				<expand-outlined class="mileage-header-tags-right" />
				<div class="pl-3">最大化</div>
			</div>
			<div class="right-menu-item" @click="openWindow">
				<select-outlined class="mileage-header-tags-right" />
		...
		>
			<template #leftExtra>
				<div class="mileage-admin-tabs-arrow" @click="scrollLeft">
					<left-outlined />
				</div>
			</template>
			<template #rightExtra>
				<div class="mileage-admin-tabs-arrow" @click="scrollRight">
					<right-outlined />
				</div>
			</template>
...
<style lang="less">
	.mileage-admin-tabs {
		&.ant-tabs {
			...
			.mileage-admin-tabs-drop,
			.mileage-admin-tabs-arrow,
