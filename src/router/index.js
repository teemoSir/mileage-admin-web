...
import bigscreenRouter from './bigscreenRouter'
...
// 系统路由
const routes = [...systemRouter, ...bigscreenRouter, ...whiteListRouters, ...routes_404]
...
// 设置标题
// document.title = sysBaseConfig.MILEAGE_SYS_NAME
...
router.beforeEach(async (to, from, next) => {
	...
	const sysBaseConfig = tool.data.get('MILEAGE_SYS_BASE_CONFIG') || store.sysBaseConfig
	// 动态标题
	document.title = to.meta.title
		? `${to.meta.title} - ${sysBaseConfig.MILEAGE_SYS_NAME}`
		: `${sysBaseConfig.MILEAGE_SYS_NAME}`
