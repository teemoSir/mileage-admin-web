					...
					<a-col :span="12">
						<a-form layout="horizontal" :label-col="{ span: 6 }">
							...
							<a-form-item label="支付订单号：">
								<span class="form-inside-span-content">{{ detail.discountAmount }}</span>
							</a-form-item>
...
<script setup name="settlementDetail">
	...
	import TrafficDetail from '@/views/billing/billingtrafficrecord/trafficDetail.vue'
	import TrafficIndex from '@/views/billing/billingtrafficrecord/index.vue'
	...
	const onOpen = (record) => {
		...
		billingSettlementApi.billingSettlementDetail(Object.assign(param)).then((data) => {
			if (data) {
