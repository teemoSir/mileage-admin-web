<template>
	...
	<SectionDetail v-show="!ishowTable" ref="formDetailRef" @successful="onClose"></SectionDetail>
</template>

<script setup name="highwaysection">
	import tool from '@/utils/tool'
	import highwayfee from '@/api/highwayfee/highwayfeeSection'
	import SectionDetail from './detail.vue'
