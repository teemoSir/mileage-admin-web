		...
		<div class="beidou-title">
			...
			<a-row>
				<a-col :span="12" style="text-align: center;">
					<a-row style="text-align: center;">
						<a-col :span="24" style="text-align: center;">
							<a-progress type="circle" :percent="numberFormate(datapreview.fxzdCount/datapreview.allVehicleCount)" :width="80">
								<template #format="percent">
									<span style="font-size: 20px">{{ tool.groupSeparator(datapreview.fxzdCount) }} </span>
								</template>
							</a-progress>
						</a-col>
					</a-row >
				...
				<a-col :span="12" style="text-align: center;">
					<a-row style="text-align: center;">
						<a-col :span="24" style="text-align: center;">
							<a-progress type="circle" :percent="numberFormate(datapreview.hyptCount/datapreview.allVehicleCount)" :width="80">
								<template #format="percent">
									<span style="font-size: 20px">{{ tool.groupSeparator(datapreview.hyptCount) }} </span>
								</template>
							</a-progress>
						</a-col>
					</a-row >
			...
			<a-row style="padding-top: 20px;">
				<a-col :span="12" style="text-align: center;">
					<a-row style="text-align: center;">
						<a-col :span="24" style="text-align: center;">
							<a-progress type="circle" :percent="numberFormate(datapreview.lwlkCount/datapreview.allVehicleCount)" :width="80">
								<template #format="percent">
									<span style="font-size: 20px">{{ tool.groupSeparator(datapreview.lwlkCount) }} </span>
								</template>
							</a-progress>
						</a-col>
					</a-row >
				...
				<a-col :span="12" style="text-align: center;">
					<a-row style="text-align: center;">
						<a-col :span="24" style="text-align: center;">
							<a-progress type="circle" :percent="numberFormate(datapreview.xnyCount/datapreview.allVehicleCount)" :width="80">
								<template #format="percent">
									<span style="font-size: 20px">{{ tool.groupSeparator(datapreview.xnyCount) }} </span>
								</template>
							</a-progress>
						</a-col>
					</a-row >
