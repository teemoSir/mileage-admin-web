<template>
	<a-row style="height: 100%">
		...
		<a-col style="height: 100%;background: white" :span="19">
				...
				<a-form ref="searchFormRef" name="advanced_search" class="ant-advanced-search-form" :model="searchFormState">
					<a-row :gutter="24">
						...
						<a-col :span="8">
							...
							<a-button class="mileage-buttom-left" @click="reset">
			...
			<div style="height: 10px;background: #F6F7F7"/>
			<a-card :bordered="false">
				<s-table
					ref="table"
					:columns="columns"
